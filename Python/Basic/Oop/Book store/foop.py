...
def search_command():
    list1.delete(0, END)
    for r in database.search(title_text.get(), author_text.get(), year_text.get(), price_text.get()):
        list1.insert(END, r)

def add_command():
    list1.delete(0, END)
    database.insert(title_text.get(), author_text.get(), year_text.get(), price_text.get())
...
def update_command():
    try:
        database.update(selected_row[0], title_text.get(), author_text.get(), year_text.get(), price_text.get())
    except:
        pass
